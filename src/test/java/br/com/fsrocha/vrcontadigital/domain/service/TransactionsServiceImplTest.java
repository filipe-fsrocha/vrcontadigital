...
class TransactionsServiceImplTest {
    ...
    @Test
    @DisplayName("Transaction deposit with success")
    ...
    void testCreateTransactionsSuccessfully() {
        // Assemble
        String keyPix = "0011";
        String password = "0022";
        BigDecimal amount = BigDecimal.valueOf(10.0);
    ...
    @Test
    @DisplayName("Create new balance with none exists")
    void testCreateNewBalanceWithNoneExists() {
        // Assemble
        String keyPix = "0011";
        String password = "0022";
        BigDecimal amount = BigDecimal.valueOf(10.0);
    ...
    @Test
    @DisplayName("Create new transaction with exists balance")
    void testCreateNewTransactionExistsBalance() {
        // Assemble
        String keyPix = "0011";
        String password = "0022";
        BigDecimal amount = BigDecimal.valueOf(10.0);
